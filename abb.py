...
if __name__ == '__main__':
    ...
    abb = Robot(ip)
    abb.set_dio(1,1)
    # abb.set_speed([100,500,5000,1000])
    abb.set_speed([250,500,5000,1000])# fisrt prame to control speed

    joint_list =    [[98.3218,26.2561,-12.6149,0.000100979,76.3659,-79.7669],
    ...
    for joint in joint_list:
        ...
        # print(f"joint: {abb.get_joints()}")s
        # with open('data_joints.json','w',encoding='utf-8') as f:
        #     json.dump(abb.get_joints(),f ,ensure_ascii=False, indent=4)


    # # abb.set_speed([50,50,50,50])
    # abb.set_joints([0,0,0,0,0,0])

    # with open('data_joints.json','w',encoding='utf-8') as f:
    #     json.dump(abb.get_joints(),f ,ensure_ascii=False, indent=4)

    # abb.set_joints([0,50,0,0,0,0])
    ...
    # abb.set_joints([90,0,0,0,0,0])

    # with open('data_joints.json','w',encoding='utf-8') as f:
    #     json.dump(abb.get_joints(),f ,ensure_ascii=False, indent=4)

    # abb.set_joints([90,50,0,0,0,0])
    ...
    # while True:
    #     abb.set_joints([0,0,0,0,0,0])
    #     abb.set_joints([50,0,0,0,0,0])
        # abb.set_cartesian([[352,18,398],[0.708,0.0345,0.704,-0.0168]])
