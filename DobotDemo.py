...
class DobotDemo:
    ...
    def start(self):
        ...
        self.dashboard.StartDrag() #tech_mode
        # pass
        # self.dashboard.DO(0, 1)  # 设置数字输出1为高电平
        for i in range(25):
            self.dashboard.DO(i, 0)  # 设置数字输出1为高电平
            print(f"succese{i}")

        # b = self.dashboard.GetDO(1)
        # print(b)
        # a = self.dashboard.GetToolDO(1)
        # print(a)
        # while True:
